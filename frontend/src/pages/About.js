...
const AboutPage = () => {
  return (
    <Box sx={{ 
      ...
      <Divider sx={{ borderColor: '#757575', my: 4, borderWidth: "2px" }} />

      <Grid container spacing={4}>
        <Grid item xs={12} md={6}>
          <Typography variant="h4" sx={{ color: "#424242", fontWeight: "600" }}>Fair Market Estimations</Typography>
          <Typography mt={1}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h4" sx={{ color: "#424242", fontWeight: "600" }}>Clear & Transparent Offers</Typography>
          <Typography mt={1}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h4" sx={{ color: "#424242", fontWeight: "600" }}>Immediate Purchase – No Commission</Typography>
          <Typography mt={1}>
      ...
      <Divider sx={{ borderColor: '#757575', my: 6, borderWidth: "2px" }} />

      <Box mb={4}>
        <Typography variant="h4" sx={{ 
          color: "#424242",
          fontWeight: "600",
          textShadow: "0 1px 2px rgba(117, 117, 117, 0.2)"
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={6}>
          <Typography variant="h4" sx={{ color: "#424242", fontWeight: "600" }}>How to Sell</Typography>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h4" sx={{ color: "#424242", fontWeight: "600" }}>Art Objects – Beauties of the World</Typography>
          <ul style={{ marginLeft: '20px' }}>
