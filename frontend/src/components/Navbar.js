...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { text: "Mr Pierre Lacroix", to: "/rodolphe-meyer", icon: <PersonIcon /> },
  ...
  return (
    <>
      <AppBar
        ...
        sx={{
          background: "#fafafa",
          boxShadow: "0 4px 20px rgba(117, 117, 117, 0.08)",
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: "0 4px 15px rgba(117, 117, 117, 0.2)",
                  },
                }}
              >
                {text}
      ...
      sx={{
        ...
        mt:16,
        boxShadow: "0 4px 20px rgba(117, 117, 117, 0.08)",
        borderRight: "1px solid rgba(117, 117, 117, 0.1)",
      }}
    role="presentation"
